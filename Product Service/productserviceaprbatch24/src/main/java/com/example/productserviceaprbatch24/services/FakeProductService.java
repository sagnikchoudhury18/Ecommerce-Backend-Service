...
public class FakeProductService implements ProductService {
    ...
    public Product getProductById(Long id) {
        ...
        /*With this we will alwyas be calling a specifc server so that is why we call only userservice
        UserDto userDto = restTemplate.getForObject("http://localhost:9000/users/1", UserDto.class);
        */
